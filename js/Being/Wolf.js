    ...
    var obj = {
      ...
      think: function(other) {
        ...
        if (d < wolf_vis_range && (
          ...
          if (other.otype === 'Wolf') {
            this.set('status', 'mating');
          } else if (other.otype === 'Sheep') {
      ...
      act: function(other) {
        if (this.get('status') == 'mating' &&
          ...
          console.log('new wolf born!');
        } else if (this.get('status') === 'eating'
            && other.otype == 'Sheep' && other.color == white) {
            this.set('status', 'eating');
            other.color = 'red';
            other.set('energy', 0);
